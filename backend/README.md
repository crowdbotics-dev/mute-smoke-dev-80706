...
## Project Structure
    ...
    ├── mute_smoke_dev_80706  # Django project configurations
...
1. Clone this repo and `cd mute_smoke_dev_80706`
...
2. Clone this repo and `cd mute_smoke_dev_80706`
